...
import { validateContact, validateEmail, validateIndianMobileNumber, validateName, validateNumber } from '../api-client/validators';
...
export default function DoctorForm({ doctor, select }) {
    ...
    async function handelSubmit(params) {
        if (doctor) {
            ...
            if(!validateIndianMobileNumber(contactNo)){
