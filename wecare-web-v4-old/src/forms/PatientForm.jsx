...
import { validateContact, validateEmail, validateIndianMobileNumber, validateName, validateNumber, validatePassword } from '../api-client/validators';
...
export default function PatientForm({ active, select, dataObject, pData }) {
    ...
    async function handelSubmit(params) {
        if (active) {
            ...
            if(!validateIndianMobileNumber(contact)){
                newErrors.data = "Invalid Number Enter Number valid"
            }
        ...
        <>
            ...
            <div className="form-field-container">
                ...
                <div className="input-cell">
                    ...
                    <input type="text" className="input-box" maxLength={'10'} id="contact" placeholder="Enter Contact" value={contact} onChange={(e) => {
